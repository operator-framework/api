...
func TestDirectoryLoader(t *testing.T) {
	...
	loader := NewSQLLoaderForDirectory(store, "../../test/data/manifests")
...
func TestDirectoryLoaderWithBadPackageData(t *testing.T) {
	...
	require.NoError(t, copy.Copy("../../test/data/manifests", dir))
...
func TestQuerierForDirectory(t *testing.T) {
	...
	loader := NewSQLLoaderForDirectory(load, "../../test/data/manifests")
	require.NoError(t, loader.Populate())
