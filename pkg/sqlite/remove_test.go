...
func TestRemover(t *testing.T) {
	...
	etcdFirstVersion := &ImageLoader{
		...
		directory: "../../test/data/bundles/etcd.0.9.0",
	}
	...
	etcdNextVersion := &ImageLoader{
		...
		directory: "../../test/data/bundles/etcd.0.9.2",
	}
	...
	prometheusFirstVersion := &ImageLoader{
		...
		directory: "../../test/data/bundles/prometheus.0.14.0",
	}
	...
	prometheusSecondVersion := &ImageLoader{
		...
		directory: "../../test/data/bundles/prometheus.0.15.0",
	}
	...
	prometheusThirdVersion := &ImageLoader{
		...
		directory: "../../test/data/bundles/prometheus.0.22.2",
	}
