...
func (in *ClusterServiceVersionSpec) DeepCopyInto(out *ClusterServiceVersionSpec) {
	*out = *in
	...
	if in.ConversionWebhookDefinitions != nil {
		in, out := &in.ConversionWebhookDefinitions, &out.ConversionWebhookDefinitions
		*out = make([]ConversionWebhookDescription, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConversionWebhookDescription) DeepCopyInto(out *ConversionWebhookDescription) {
	*out = *in
	if in.URL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConversionWebhookDescription.
func (in *ConversionWebhookDescription) DeepCopy() *ConversionWebhookDescription {
	if in == nil {
		return nil
	}
	out := new(ConversionWebhookDescription)
	in.DeepCopyInto(out)
	return out
}
